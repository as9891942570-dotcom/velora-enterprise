  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4 rounded-xl border border-border bg-card p-6 shadow-sm" autoComplete="off">
          <div>
          ...
          <div>
            <label htmlFor="velora-admin-password" className="mb-1.5 block text-sm font-medium">
              Password
            </label>
            <input
